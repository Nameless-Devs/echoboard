...
VALUES ('Misaligned Goals Between Sales and Product Development',
...
VALUES ('Lack of Collaboration Between Marketing and Engineering',
...
INSERT INTO "echo_board" (title, content, author, upvote)
VALUES ('Data Sharing Challenges Between IT and Finance',
...
INSERT INTO "echo_board" (title, content, author, upvote)
VALUES ('Conflicting Priorities Between HR and Operations',
...
INSERT INTO "echo_board" (title, content, author, upvote)
VALUES ('Communication Gaps Between Customer Support and R&D',
        'Communication gaps between our customer support and research and development (R&D) teams have led to customer dissatisfaction. Customer support may not adequately convey customer feedback and issues to R&D, resulting in product improvements being delayed or overlooked. Bridging these gaps is crucial for product enhancement.',
        'Customer Support Manager', 0);
