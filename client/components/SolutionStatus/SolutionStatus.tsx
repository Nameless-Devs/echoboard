...
//But i left it for not, will delete later is it's completely useless for us #Ana
    ...
    <>
      <div ref={anchorRef}>
        <ClickAwayListener onClickAway={handleClose}>
          <Chip
            color={chipColor}
            disabled={false} //that should be false for the OP and true for everyone else
            size="small"
            variant="filled"
            onClick={handleClick}
      ...
      <FormControl>
        ...
        >
          ...
          <MenuItem value="IMPLEMENTATION_IN_PROGRESS">
