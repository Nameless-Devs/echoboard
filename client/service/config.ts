export const ENDPOINTS = {
  ...
  UPVOTE_COMMENT: `${process.env.NEXT_PUBLIC_API_BASE_URL}/echoes/{echoBoardId}/comments/{commentId}/upvote`,
  ...
  UPVOTE_SOLUTION: `${process.env.NEXT_PUBLIC_API_BASE_URL}/echoes/{echoBoardId}/solutions/{solutionId}/upvote`,
};
