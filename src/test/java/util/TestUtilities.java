...
public class TestUtilities {
    ...
    public static void assertEchoBoardEqual(EchoBoard expected, EchoBoardResponseDto actual) {
        Assertions.assertNotNull(actual, "Actual EchoBoard should not be null");
        Assertions.assertEquals(expected.getTitle(), actual.title());
    ...
    public static EchoBoard echoBoardSample() {
        ...
        return new EchoBoard(title, content, true);
    }
