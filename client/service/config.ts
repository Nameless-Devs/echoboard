export const ENDPOINTS = {
  ...
  ECHOBOARD_BY_SOLUTION: `${process.env.NEXT_PUBLIC_API_BASE_URL}/solutions/{solutionId}/echoboard-by-solution`,
  ECHOBOARD_BY_COMMENT: `${process.env.NEXT_PUBLIC_API_BASE_URL}/solutions/{solutionId}/echoboard-by-comment`,
