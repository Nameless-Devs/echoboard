...
export const AcceptingVolunteersWindow: React.FC<
  AcceptingVolunteersWindowProps
> = ({ open, onClose, volunteers, pendingVolunteers, solutionId }) => {
  return (
    <Modal open={open} onClose={onClose}>
      ...
      >
        ...
        {pendingVolunteers &&
        Array.isArray(pendingVolunteers) &&
        pendingVolunteers.length === 0 &&
        pendingVolunteers !== undefined ? (
        ...
        {volunteers && Array.isArray(volunteers) && volunteers.length === 0 ? (
          <Typography textAlign={"center"}>
            You have no accepted volunteers
          </Typography>
        ) : (
