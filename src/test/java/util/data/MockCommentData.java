...
public class MockCommentData {
    ...
    public static List<EchoBoardCommentResponse> COMMENTS_SALES = List.of(
            new EchoBoardCommentResponse(
                    ...
                    new EchoBoardUserResponse("John Doe", "https://example.com/avatar.png")
            ),
            new EchoBoardCommentResponse(
                    ...
                    new EchoBoardUserResponse("Jane Doe", "https://example.com/avatar.png")
            ),
            new EchoBoardCommentResponse(
